...
function TipCard({ number, text }: { number: number; text: string }) {
  return (
    <div className="relative bg-white border-2 rounded-xl p-6 shadow-sm hover:shadow-md transition-all">
      <div className="absolute -top-3 -left-3 bg-green-600 text-white rounded-full w-8 h-8 flex items-center justify-center">
...
function ErrorCard({ number, text }: { number: number; text: string }) {
  return (
    <div className="relative bg-white border-2 rounded-xl p-6 shadow-sm hover:shadow-md transition-all">
